        ...
        <div>
            ...
            {!ads?.length ? (
              <div className="d-flex justify-content-center align-items-center vh-100">
                <h2 className="text-muted" style={{marginTop: "-40%"}}>You have not liked any property, Yet!!!</h2>
              </div>
            ) : (
              <div className="container">
                <div className="row">
                  <div className="col-lg-8 offset-lg-2">
                    <h2 className="mt-5 mb-5">Wishlist Bucket</h2>
                    <hr/>
                    <p className="text-center text-muted">You have liked {ads?.length} ads</p>
                  </div>
                </div>
